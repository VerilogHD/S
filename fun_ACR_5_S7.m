function [PIU,mu_S7,pf_hdl]=fun_ACR_5_S7(dir_name,file_name,visual,imag_check,choice)
...
if isfield(dicominfo(path_name),'MagneticFieldStrength')
    ...
    choice=dummy.MagneticFieldStrength;
    choice=num2str(choice);
    choice=[choice 'T'];
else
    choice=questdlg('What scanner do you use?', ...
        '','1.5T','3T','3T');
end
%===================v6 end===================
switch choice
